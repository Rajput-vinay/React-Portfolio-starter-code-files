  ...
  export const LinkedIn = (props) => {
    return (
      ...
      >
        <path
          fill={props.fill}
          d="M100.28 448H7.4V165.7h92.88V448zm-46.4-293.4c-29.74 0-54.3-24.5-54.3-54.3 0-29.7 24.6-54.3 54.3-54.3 29.7 0 54.3 24.6 54.3 54.3 0 29.8-24.6 54.3-54.3 54.3zM447.1 448h-92.9V306.7c0-33.9-12.1-57.1-42.6-57.1-23.3 0-37.2 15.7-43.2 30.7-2.2 5.2-2.8 12.4-2.8 19.6v148.3h-92.9V165.7h89.5v37.2c11.7-17.9 32.8-43.2 79.2-43.2 57.9 0 101.7 37.9 101.7 119.4V448z"
        />
      </svg>
    );
  };
